			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						...
						<input type="password" name="password" id="password" class="form-control input-lg" placeholder="Password"  title="Must contain at least one number and one uppercase and lowercase letter and can use speical charecter (-_), and at least 16 or more characters" required>
						<p id=err_password></p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6">
...
<!--Question-->		
			...
			<label for="terms">By Creating an Account, you Agree<a href="terms.php" title="You May Read Our Terms and Conditions by Clicking on This Link" data-toggle="modal" data-target="#myModal" >Term of service.</a> for Registration.</label>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
		  ...
		  <p>1.Applicants for membership of the website can register only one account per person.<br>
2.Website member’s personal detail have to be correctly given otherwise admin will not allow your membership.<br>
3.we keep your personal information save other people can’t access to your information.<br>
4.Website member must keep username and password save and must no share it with other people.<br>
5. Website member will be responsible for any damages incurred as a result of their use of the Site.<br>	
6.Website Admin can change member website’s role or delete account with out notice that user if that user don’t follow this term of service or<br>
- Members of the website write and publish illegal articles, threatening, threatening, defamatory, abusive, vulgar, obscene, profane, defamatory, or otherwise defamatory, or defamatory or defamatory. Or articles that incites riots.<br>
- Members of the site make comments that are threatening, defamatory, libelous, abusive, vulgar, obscene, profane, abusive, disrespectful. Or to incite riots.<br>
...
<script type="text/javascript">
	...
	var pattern_username =/[0-9a-zA-Z\-\_]{1,}$/;
...
err_username.innerHTML = "";
	if(username.value != "") {
		if(username.value.match(pattern_username)){
			$.post('checkdataUsername.php', { username: username.value}, function(data) {
			data = $.parseJSON(data);
			if(data.count > 0 ){
